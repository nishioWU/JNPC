...
2018年9月の自主ゼミ用の資料です。右上の｢Clone or download｣から｢Download ZIP｣を選んで下さい。データフォルダのパスワードは事務局からご案内します。  
Rの関係で若干、資料を追加する予定です。講義前日にもう一度、こちらを覗いてみて下さい。  
...
RとRStudioのインストール部分はもう変更ありません。参加予定の方は、どうぞインストールして下さって結構です。
