...
htmlwidgets::saveWidget(config(plt_M, showLink = FALSE, collaborate = FALSE, displayModeBar = FALSE), "liver1)M_0922.html")
print(plt_M)
...
htmlwidgets::saveWidget(config(plt_F, showLink = FALSE, collaborate = FALSE, displayModeBar = FALSE), "liver2)F_0922.html")
print(plt_F)
