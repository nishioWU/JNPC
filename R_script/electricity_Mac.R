...
# Windowsの場合はこれでもOK
# ggsave('../outcome/electricity_0922.pdf', plt, width = 297, height = 210, units = 'mm')

# Macでも文字化けしないようCairoを使う。A４判サイズをインチで指定
cairo_pdf("../outcome/electricity_0922.pdf", width = 11.69, height = 8.27, family = "Japan1GothicBBB")
print(plt)
dev.off()
